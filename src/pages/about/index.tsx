...
import { a1, a10, a11, a15, a2, a3, a5, a8, a9, About, PhungNguyenCertification } from '~/assets'
...
const AboutPage = () => {
  ...
  return (
    <>
      <Layout header={<PageHeader imageURL={a1} title='About PHUNG NGUYEN GARMENT' />}>
        <Section
          titleProps={{
            title: 'Về chúng tôi'
          }}
        ...
        <Section spacing={false}>
          <Flex className='relative h-fit w-full before:absolute before:bottom-0 before:left-0 before:right-0 before:top-0 before:bg-black before:bg-opacity-[50%] before:content-[""]'>
            <Image
              src={a5}
              alt='bg-footer'
              width={900}
        ...
        <Section
          ...
          className='relative before:absolute before:bottom-0 before:left-0 before:right-0 before:top-0 before:z-0 before:opacity-[15%] before:content-[""]'
        >
